              ...
              <div className="z-10 flex-1 text-left min-w-0">
                <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                  ...
                  <div className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-violet-500/15 border border-violet-500/20 text-violet-400 text-[9px] font-bold uppercase tracking-wider font-mono">
                    <Sparkles className="w-3 h-3" /> Bet: 50 Coins
                  </div>
                </div>
                <p className="text-gray-400 text-xs leading-relaxed max-w-md truncate">
                  Challenge online players in real-time or duel friends in private lobbies.
                </p>
              </div>

              {/* Shrunk Hero image/icon */}
              <div className="z-10 w-14 h-14 shrink-0 hidden sm:flex items-center justify-center p-0.5 bg-slate-950/40 rounded-xl border border-white/5 shadow-inner aspect-square overflow-hidden">
                <img 
                  src="/tic_tac_toe_hero.png" 
                  alt="Tic-Tac-Toe Neon Board" 
                  className="rounded-lg w-full h-full object-cover aspect-square hover:scale-105 transition-transform duration-500"
                />
              </div>
            </div>
